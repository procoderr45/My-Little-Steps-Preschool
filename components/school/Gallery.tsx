...
const PHOTOS = [
    { id: 1, src: "/images/gallery/art1.jpg", cat: "Art & Craft", label: "Finger Painting Day", color: P.coral, grad: g.coral, span: "col-span-2 row-span-2" },
    { id: 2, src: "/images/gallery/sports1.jpg", cat: "Sports", label: "Sports Morning", color: P.teal, grad: g.teal, span: "col-span-1 row-span-1" },
    { id: 3, src: "/images/gallery/learn1.jpg", cat: "Learning", label: "Story Time", color: P.sky, grad: g.sky, span: "col-span-1 row-span-1" },
    ...
    { id: 5, src: "/images/gallery/nature1.jpg", cat: "Nature", label: "Garden Explorers", color: P.purple, grad: g.purple, span: "col-span-1 row-span-1" },
    { id: 6, src: "/images/gallery/art2.jpg", cat: "Art & Craft", label: "Clay Modelling", color: P.pink, grad: g.purple, span: "col-span-1 row-span-1" },
    { id: 7, src: "/images/gallery/sports2.jpg", cat: "Sports", label: "Yoga & Movement", color: P.teal, grad: g.teal, span: "col-span-2 row-span-1" },
    ...
    { id: 9, src: "/images/gallery/event2.jpg", cat: "Events", label: "Diwali Celebrations", color: P.amber, grad: g.amber, span: "col-span-1 row-span-1" },
    { id: 10, src: "/images/gallery/nature2.jpg", cat: "Nature", label: "Butterfly Garden", color: P.purple, grad: g.purple, span: "col-span-1 row-span-2" },
    { id: 11, src: "/images/gallery/art3.jpg", cat: "Art & Craft", label: "Watercolour Workshop", color: P.coral, grad: g.coral, span: "col-span-1 row-span-1" },
                ...
                <motion.div
                    ...
                    <div className="flex flex-col sm:flex-row gap-4">
                        <motion.button whileHover={{ scale: 1.04 }} whileTap={{ scale: 0.97 }}
                            className="px-8 py-3.5 rounded-full text-white font-semibold text-sm tracking-wide shadow-xl"
                            style={{
                                background: `linear-gradient(135deg, ${P.purple}, ${P.pink})`,
                                fontFamily: "'Jost', sans-serif", letterSpacing: "0.07em",
                                boxShadow: `0 8px 28px ${P.purple}40`,
                            }}>
                            View Full Gallery →
                        </motion.button>
                        <motion.button whileHover={{ scale: 1.04 }} whileTap={{ scale: 0.97 }}
                            className="px-8 py-3.5 rounded-full font-semibold text-sm tracking-wide"
                            style={{
                                fontFamily: "'Jost', sans-serif", letterSpacing: "0.07em",
                                background: "rgba(255,253,248,0.9)",
                                border: `1.5px solid ${P.purple}28`,
                                color: P.purple,
